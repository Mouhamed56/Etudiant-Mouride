...
const BOOKS = [
  { key:'b1', pdf:'pdf/600827886-GuideMouridisme.pdf' },
  { key:'b2', pdf:"pdf/459418059-Serigne-Bachir-MBACKE-les-bienfaits-de-l-eternel-livre-pour-petit-ecran-pdf%20(1).pdf" },
  { key:'b3', pdf:'pdf/50802987-LES-KHASSAIDES-DE-SERIGNE-TOUBA.pdf' },
  { key:'b4', pdf:'pdf/49624810-DIAZBULMOURID.pdf' },
];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {BOOKS.map(b => (
            <div key={b.key} className="bg-mouride-cream rounded-2xl p-6 card-hover text-center">
              ...
              <h3 className="font-display font-bold text-mouride-green mb-2">{t(`lib.${b.key}title`)}</h3>
              <p className="text-sm text-gray-600 mb-4">{t(`lib.${b.key}desc`)}</p>
